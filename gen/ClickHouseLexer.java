// Generated from /Users/libinsong/Documents/codes/tongdun/dataworker-sql-parser/src/main/antlr4/com/dataworker/sql/parser/antlr4/clickhouse/ClickHouseLexer.g4 by ANTLR 4.8
...
public class ClickHouseLexer extends Lexer {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'Enum8'", "'Enum16'", "'UUID'", "'Date'", "'DateTime'", "'String'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"K_WEEK", "K_WHEN", "K_WHERE", "K_WITH", "K_YEAR", "COLON", "COMMA", 
			"SEMI", "LPAREN", "RPAREN", "RARROW", "LT", "GT", "QUESTION", "STAR", 
			"PLUS", "CONCAT", "OR", "DOLLAR", "DOT", "PERCENT", "MINUS", "DIVIDE", 
