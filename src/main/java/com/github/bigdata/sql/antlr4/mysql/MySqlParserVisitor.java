...
public interface MySqlParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code updateCurrentTimestamp}
	 * labeled alternative in {@link MySqlParser#columnConstraint}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUpdateCurrentTimestamp(MySqlParser.UpdateCurrentTimestampContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MySqlParser#updateTime}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUpdateTime(MySqlParser.UpdateTimeContext ctx);
	/**
